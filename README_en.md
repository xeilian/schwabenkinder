...
| schwabenkinder_vergleiche.xlsx | Yes | This file contains three evaluations that were used as comparisons from the database data. Table *VG Tirol, Uh. 1901-13* shows an evaluation by Otto Uhlig of school exemptions and pass registers per place of origin for the years 1901/04/05/09/13[^fn5]. Table *VG Tirol, VB 1895* shows the statistics from the Tyrolean People's Messenger of April 25, 1895, which assigned 220 children to the individual municipalities of Tyrol[^fn6]. Table *VG VB, Uh. 1922-23* covers the places of origin of 161 children from the years 1922 and 1923, which Uhlig determined using school records[^fn7]. |
